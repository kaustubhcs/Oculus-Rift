...
#region Unity Messages
	...
	private void UpdateAnchors()
	{
		...
		bool eye_seperate = true;
		if (eye_seperate == false) {

					
		leftEyeAnchor.localPosition = leftEye.position;
		centerEyeAnchor.localPosition = 0.5f * (leftEye.position + rightEye.position);  // Changes made by `
		rightEyeAnchor.localPosition = rightEye.position;
						...
						leftEyeAnchor.localPosition = leftEye.position;
						centerEyeAnchor.localPosition = 0.5f * (leftEye.position + rightEye.position);  // Changes made by KTB
						rightEyeAnchor.localPosition = rightEye.position + 100 * Vector3.one;
						print ("Left Eye");
						print (leftEyeAnchor.localPosition);
	
						print ("Right Eye");
						print (rightEyeAnchor.localPosition);
				}
